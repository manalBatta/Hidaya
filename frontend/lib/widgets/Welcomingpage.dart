            ...
            child: Container(
              ...
              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                 ...
                 children: [
                   ...
                   const SizedBox(height: 8),
                   Column(
                     crossAxisAlignment: CrossAxisAlignment.start, // الإيميلات على أقصى اليسار
                     children: [
                  const Text(
                    "Contact Us on emails for support",
                    style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                  ),
                  const SizedBox(height: 8),
                  GestureDetector(
                    onTap: () => _launchEmail('rubaabusam@gmail.com'),
                    child: Row(
                      children: [
                        Container(
                          width: 24,
                  ...
                  const SizedBox(height: 8),
                  GestureDetector(
                    onTap: () => _launchEmail('manalbatta@gmail.com'),
                    child: Row(
                      children: [
                        Container(
                          width: 24,
